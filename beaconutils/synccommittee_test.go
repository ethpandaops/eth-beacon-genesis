	...
	tests := []struct {
		...
		},
		{
			...
			validators: []*phase0.Validator{
				...
				{
					PublicKey:             mustDecodeHexPubkey("811a1cc964bcd4314fe43d78791f00f0b57171bf1ca6330b8de4032bb8001b7b5503a92b63728bb8d373867e6dd810d6"),
					WithdrawalCredentials: makeBytes(32, 4),
					EffectiveBalance:      32000000000,
					ActivationEpoch:       0,
					ExitEpoch:             0, // Not active at genesis
				},
			},
			randaoMix:           "4ff6f743a43f3b4f95350831aeaf0a122a1a392922c45d804280284a69eb850b",
			expectedError:       false,
